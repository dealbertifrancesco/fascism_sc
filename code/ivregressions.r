...
iv_2 = run_propensity_iv("fascist_branch", "stat_ass", df_iv_2)
summary(iv_2)
...
iv_4 = run_propensity_iv("fascist_violence", "stat_ass", df_iv_2)
summary(iv_4)
...
iv_6 = run_propensity_iv("fascist1924_vv", "stat_ass", df_iv_2)
summary(iv_6)
...
iv_8 = run_propensity_iv("fascist1919_vv", "stat_ass", df_iv_2)
summary(iv_8)
...
iv_10 = run_propensity_iv("fascist1921_vv", "stat_ass", df_iv_2)
summary(iv_10)
...
iv_12 = run_propensity_iv("deportations_d", "stat_ass", df_iv_2)
summary(iv_12)
...
iv_14 = run_propensity_iv("depo_pop_cap1", "stat_ass", df_iv_2)
summary(iv_14)
...
iv_16 = run_propensity_iv("dlf_1926", "stat_ass", df_iv_2)
summary(iv_16)
...
export_iv_table(iv_5, iv_6, "Fascist 1921 Vote Share", file.path(tables_dir, "Fascist_1921_Vote_Share_pz.tex"))
